...
class IActor
{
    public:
        ...
        /// <summary> Virtual destructor ensures inheritance issues.
        virtual ~IActor() {}

        /// <summary>
        /// Causes an Actor to initialise itself. This should be called before using any Actor.
        ...
        /// <summary>
        /// Causes an Actor to update itself based on the delta-time value given. This should not update any simulation information.
        /// </summary>
        virtual void update (const float deltaTime) {}

        /// <summary>
        /// Causes an Actor to perform an update of the simulation based on the delta-time value given. This is where all physics calculations should go.
        /// </summary>
